...
anychart.ganttModule.TimeLine = function(opt_controller, opt_isResources) {
   ...
   * @private
   */
  this.bar_ = new anychart.ganttModule.elements.Base(this, anychart.enums.TLElementTypes.BASE);
  this.bar_.rendering().shapes([anychart.ganttModule.rendering.shapes.barConfig]);
  this.bar_.listenSignals(this.visualElementInvalidated_, this);
   ...
   * @private
   */
  this.milestone_ = new anychart.ganttModule.elements.Base(this, anychart.enums.TLElementTypes.MILESTONE);
  this.milestone_.parent(this.bar_);
  this.milestone_.listenSignals(this.visualElementInvalidated_, this);
   ...
   * @private
   */
  this.parent_ = new anychart.ganttModule.elements.Base(this, anychart.enums.TLElementTypes.PARENT);
  this.parent_.parent(this.bar_);
  this.parent_.listenSignals(this.visualElementInvalidated_, this);
  ...
  this.progress_.parent(this.bar_);
   ...
   * @private
   */
  this.baseline_ = new anychart.ganttModule.elements.Base(this, anychart.enums.TLElementTypes.BASELINE);
  this.baseline_.parent(this.bar_);
  this.baseline_.listenSignals(this.visualElementInvalidated_, this);
 ...
 */
anychart.ganttModule.TimeLine.prototype.bar = function(opt_value) {
  if (goog.isDef(opt_value)) {
    this.bar_.setup(opt_value);
    return this;
  }
  return this.bar_;
};
 ...
 * @return {anychart.ganttModule.elements.Base|anychart.ganttModule.TimeLine}
 */
anychart.ganttModule.TimeLine.prototype.milestone = function(opt_value) {
  if (goog.isDef(opt_value)) {
    this.milestone_.setup(opt_value);
    return this;
  }
 ...
 * @return {anychart.ganttModule.elements.Base|anychart.ganttModule.TimeLine}
 */
anychart.ganttModule.TimeLine.prototype.parent = function(opt_value) {
  if (goog.isDef(opt_value)) {
    this.parent_.setup(opt_value);
    return this;
  }
  return this.parent_;
};
 ...
 * @return {anychart.ganttModule.elements.Base|anychart.ganttModule.TimeLine}
 */
anychart.ganttModule.TimeLine.prototype.baseline = function(opt_value) {
  if (goog.isDef(opt_value)) {
    this.baseline_.setup(opt_value);
    return this;
  }
...
anychart.ganttModule.TimeLine.prototype.drawAsBaseline_ = function(dataItem, totalTop, itemHeight) {
  ...
  if ((actualEndRatio > 0 && actualStartRatio < 1) || (baselineEndRatio > 0 && baselineStartRatio < 1)) {
    ...
    var element = isParent ? this.parent() : this.bar();
    var type = isParent ? anychart.enums.TLElementTypes.PARENT : anychart.enums.TLElementTypes.BASE;
    var labels = isParent ? this.parentLabels() : this.baseLabels();

    var tag = {
      isElement: true,
      id: dataItem.get(anychart.enums.GanttDataFields.ID),
      type: type,
      item: dataItem,
      typeLabels: /** @type {anychart.core.ui.LabelsFactory} */ (labels),
      currBounds: actualBounds
    };

    var baselineTag = {
      isElement: true,
      id: dataItem.get(anychart.enums.GanttDataFields.ID),
      type: anychart.enums.TLElementTypes.BASELINE,
      item: dataItem,
      typeLabels: /** @type {anychart.core.ui.LabelsFactory} */ (this.baselineLabels()),
      currBounds: baselineBounds
    };
    ...
    if (goog.isDefAndNotNull(progressValue)) { //Draw progress.
      ...
      var progressTag = {
        isElement: true,
        id: dataItem.get(anychart.enums.GanttDataFields.ID),
        type: anychart.enums.TLElementTypes.PROGRESS,
        item: dataItem,
        typeLabels: /** @type {anychart.core.ui.LabelsFactory} */ (this.progressLabels()),
        currBounds: progressBounds
      };
...
anychart.ganttModule.TimeLine.prototype.drawAsParent_ = function(dataItem, totalTop, itemHeight) {
  ...
  if (endRatio > 0 && startRatio < 1) { //Is visible
    ...
    var tag = {
      isElement: true,
      id: dataItem.get(anychart.enums.GanttDataFields.ID),
      type: anychart.enums.TLElementTypes.PARENT,
      item: dataItem,
      typeLabels: /** @type {anychart.core.ui.LabelsFactory} */ (this.parentLabels()),
      currBounds: actualBounds
    };
...
anychart.ganttModule.TimeLine.prototype.drawAsProgress_ = function(dataItem, totalTop, itemHeight) {
  ...
  if (endRatio > 0 && startRatio < 1) { //Is visible
    ...
    var tag = {
      isElement: true,
      id: dataItem.get(anychart.enums.GanttDataFields.ID),
      type: anychart.enums.TLElementTypes.BASE,
      item: dataItem,
      typeLabels: /** @type {anychart.core.ui.LabelsFactory} */ (this.baseLabels()),
      currBounds: actualBounds
    };
...
anychart.ganttModule.TimeLine.prototype.drawAsMilestone_ = function(dataItem, totalTop, itemHeight) {
  ...
  if (ratio >= 0 && ratio <= 1) { //Is visible
    ...
    var tag = {
      isElement: true,
      id: dataItem.get(anychart.enums.GanttDataFields.ID),
      type: anychart.enums.TLElementTypes.MILESTONE,
      item: dataItem,
      typeLabels: /** @type {anychart.core.ui.LabelsFactory} */ (this.milestoneLabels()),
      currBounds: bounds
    };
...
anychart.ganttModule.TimeLine.prototype.setupByJSON = function(config, opt_default) {
  ...
  this.bar().setupInternal(!!opt_default, config['bar']);
  this.milestone().setupInternal(!!opt_default, config['milestone']);
  this.parent().setupInternal(!!opt_default, config['parent']);
  this.progress().setupInternal(!!opt_default, config['progress']);
  this.baseline().setupInternal(!!opt_default, config['baseline']);
...
(function() {
  ...
  proto['bar'] = proto.bar;
  proto['milestone'] = proto.milestone;
