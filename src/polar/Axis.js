...
anychart.polarModule.Axis.prototype.calculateAxisBounds_ = function() {
  ...
  if (this.hasInvalidationState(anychart.ConsistencyState.BOUNDS)) {
    ...
    var majorLabelsPosition = majorLabels.position();
    var majorLabelsSidePosition = anychart.utils.sidePositionToNumber(majorLabelsPosition);

    var minorLabels = /** @type {anychart.core.ui.LabelsFactory} */(this.minorLabels());
    var minorLabelsPosition = majorLabels.position();
    var minorLabelsSidePosition = anychart.utils.sidePositionToNumber(minorLabelsPosition);
    ...
    if (scale && this.radius_ && this.enabled()) {
      ...
      var majorTicksLength = anychart.utils.getAffectBoundsTickLength(this.ticks());
      ...
      var majorAffectsRadiusTicksLength = parseFloat(anychart.utils.getAffectBoundsTickLength(this.ticks(), majorLabelsSidePosition));

      // var majorLabelsOffsetByTicks = isOrdinal ? 0 : majorTicksLength;
      var minorTicksLength = isOrdinal ? 0 : anychart.utils.getAffectBoundsTickLength(this.minorTicks()) ;
      if (anychart.utils.isPercent(minorTicksLength)) {
        minorTicksLength = parseFloat(minorTicksLength);
      }
      var minorAffectsRadiusTicksLength = isOrdinal ? 0 : parseFloat(anychart.utils.getAffectBoundsTickLength(this.minorTicks(), minorLabelsSidePosition)) ;
...
anychart.polarModule.Axis.prototype.drawTick_ = function(ticks, angle, lineThickness, tickThickness, tickLen) {
  ...
  var x = Math.round(this.cx_ + radius * cos);
  var y = Math.round(this.cy_ + radius * sin);
